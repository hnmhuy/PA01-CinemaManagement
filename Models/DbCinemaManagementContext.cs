...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A624457006");
            ...
            {
                entity.HasKey(e => e.AgeCertificateId).HasName("PK__AgeCerti__64F2799D2CBDE3F6");
            ...
            {
                entity.HasKey(e => e.BillId).HasName("PK__Bill__11F2FC6A323C9EDB");
            ...
            {
                entity.HasKey(e => new { e.BillId, e.VoucherId }).HasName("PK__BillVouc__125C1BF8311F5B92");
            ...
            {
                entity.HasKey(e => e.GenreId).HasName("PK__Genre__0385057E2F6AB6AF");
            ...
            {
                entity.HasKey(e => e.MovieId).HasName("PK__Movie__4BD2941AA4B6095D");
                ...
                entity.HasMany(d => d.Genres).WithMany(p => p.MoviesNavigation)
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("MovieId", "GenreId").HasName("PK__MovieGen__BBEAC44DAFE2E1F1");
                ...
                entity.HasMany(d => d.People).WithMany(p => p.MoviesNavigation)
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("MovieId", "PersonId").HasName("PK__MovieAct__01706BA420E849F1");
            ...
            {
                entity.HasKey(e => e.PersonId).HasName("PK__Person__AA2FFBE5D4FDD952");
            ...
            {
                entity.HasKey(e => e.ShowTimeId).HasName("PK__ShowTime__DF1BC81FEC420DB3");
            ...
            {
                entity.HasKey(e => e.TicketId).HasName("PK__Ticket__712CC607B66F4381");
            ...
            {
                entity.HasKey(e => e.VoucherId).HasName("PK__Voucher__3AEE792152A475F4");
